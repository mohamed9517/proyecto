...
<head>
    ...
    <title>Administracion Usuario</title>
...
<script type="text/javascript">
    function confirmDelet() {
        ...
        var respuest = confirm("Estas seguro que quieres eliminar el usuario");
        if (respuest == true) {
            return true;
...
<body style="background-color: #f3f2f7;">
    ...
    <div class="container-fluid" style="font-size: 13px; display: flex; justify-content: center;">
        <div class="row">
