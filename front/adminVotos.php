...
<script type="text/javascript">
    function confirmDelet() {
        ...
        var respuest = confirm("Estas seguro que quieres eliminar la valoracion del voto");
        if (respuest == true) {
            return true;
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <th>
                                        <a href="../back/adminVotoBack.php?elimi=<?php echo $row['id'] ?>" class="btn btn-danger"  onclick="return confirmDelet()" >Eliminar</a>
