...
<body style="background-color: #f3f2f7;">
    ...
    <div class="container-fluid">
                    ...
                    <div class="col-md-12 " style="display: flex; align-items: center; margin-top: 100px;">
                        <div class="col-md-12">
                            ...
                            <div>
                                ...
                                <br>
                                <p class="mt-1" style="color: black; font-size: 10px;"> <strong> La puntuacion es <?php echo round($avg, 2) ?> de 5 </strong></p>
                            </div>
                            <h3 class="mt-1" style="font-size: 40px;">$<?php echo $row['precio_producto']  ?></h3>
                        <?php }  ?>
                        <a href="cesta.php?id=<?php echo $fila['id_producto'] ?>" class="btn rounded border p-2.5 mt-4 submit2" style="background-color: white; color: black; width: 200px;">Añadir a la cesta</a>
                        </div>
                    </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="col-md-12">
                <input type="hidden" class="id form-control" value="<?php echo $id ?>"><br>
                ...
                <p>&nbsp;</p>
                <a href="javascript:void(0)" class="btn btn-primary submit" style="border-radius: 20px; background-color: white; color: black;">Añadir</a>
                <p>&nbsp;</p>
            </div>
